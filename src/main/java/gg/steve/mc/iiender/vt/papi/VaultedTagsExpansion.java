    ...
    public String onPlaceholderRequest(Player player, String identifier) {
        if (identifier.equalsIgnoreCase("selected")) {
            if (TagsManager.getInstance().hasTagSelected(player)) {
                return ColorUtil.colorize(Files.CONFIG.get().getString("placeholders.tag.format").replace("{format}", TagsManager.getInstance().getActiveTagForPlayer(player)));
            } else {
            ...
            if (TagsManager.getInstance().hasTagSelected(player)) {
                return ColorUtil.colorize(Files.CONFIG.get().getString("placeholders.tag-chat.format").replace("{format}", TagsManager.getInstance().getActiveTagForPlayer(player)));
            } else {
            ...
            if (TagsManager.getInstance().hasTagSelected(player)) {
                return ColorUtil.colorize(Files.CONFIG.get().getString("placeholders.tag-tab.format").replace("{format}", TagsManager.getInstance().getActiveTagForPlayer(player)));
            } else {
            ...
            if (TagsManager.getInstance().hasTagSelected(player)) {
                return ColorUtil.colorize(Files.CONFIG.get().getString("placeholders.tag-identifier.format").replace("{format}", TagsManager.getInstance().getActiveTagForPlayer(player)));
            } else {
            ...
            if (TagsManager.getInstance().hasTagSelected(player)) {
                return ColorUtil.colorize(Files.CONFIG.get().getString("placeholders.tag-scoreboard.format").replace("{format}", TagsManager.getInstance().getActiveTagForPlayer(player)));
            } else {
