package gg.steve.mc.iiender.vt.framework.utils.actionbarapi;
...
//            e.printStackTrace();
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(VaultedTagsPlugin.getInstance(), duration + 1);
        }
        ...
        while (duration > 40) {
            ...
            }.runTaskLater(VaultedTagsPlugin.getInstance(), (long) duration);
        }
    }
